...
#include <MFRC522.h>  // Library for Mifare RC522 Devices
  ...
  #define redLed 7    // Set Led Pins        //led pinleri ayarı
  //#define greenLed 6
  //#define blueLed 5
  
  #define relay 4     // Set Relay Pin       //yedek pin ayarı
  #define wipeB 5     // Button pin for WipeMode              //Wipe=silme
...
class SauRoRFID
{
  // #include <Servo.h>
   int SS_PIN =53;
  int RST_PIN= 48;
  boolean match = false;          // initialize card match to false         //initialize=başlatılamadı
  ...
  MFRC522& mfrc522 = *(new MFRC522 (SS_PIN, RST_PIN));
  public:
  SauRoRFID()
  {
    //RFIDbegin();
